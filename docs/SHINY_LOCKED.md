...
shiny one. Hunting these is a waste of time. The pokebot-3ds launcher
flags shiny-locked starters/legendaries with a ⚠ warning before you
start the bot, but here's the canonical list for reference (source:
